      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
		  ...
		  for (int i = 0; i < sensor_fusion.size(); i++)
		  {
			  ...
			  std::cout << "Index: " << i << " Checking lane: " << check_car_lane_num << " car lane: " << lane_num << "check_car_s: " << check_car_s << " car_s: " << car_s << " abs(check_car_s - car_s): " << abs(check_car_s - car_s) << " d: " << d << std::endl;
